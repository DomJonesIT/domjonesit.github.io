...
$('.slider').each(function() {					// For each slider
	...
	$group.animate( {left:animateLeft} , function() {			// Animate slides and
		...
		$group.css( {left: 0} );									// Set position of the group of slide
	...
	function advance() {							// Sets a timer between slides
		clearTimeout(timeout);					// Clear timer between slides
...
buttonArray.push($button);						// Add to the button array
});

advance();										// Script is set up - call advance() to start 			
